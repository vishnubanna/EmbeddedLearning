...
void splash(void)
{
  ...
  msg(40,1, 0x0f,  "        Story:       ");
  msg(40,2, 0x0f,  "  In the Midst of a  ");
  msg(40,3, 0x0f,  "  Global pandemic,a  ");
  msg(40,4, 0x0f,  " Group of evil toads ");
  msg(38,5, 0x0f,  " are throwing out good ");
  msg(40,6, 0x0f,  "  good medicine.You  ");
  msg(40,7, 0x0f,  "  need to catch as   ");
  msg(40,8, 0x0f,   " much as you can to  ");
  msg(39,9, 0x0f,  " to save you village. ");
  msg(40,10, 0x0f,   " But don't get shot, ");
  msg(38,11, 0x0f, " or you will die trying! ");
  render();
}
