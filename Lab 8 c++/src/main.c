...
void spi_init_lcd(void) {
	...
	int br = SPI_CR1_BR_1|SPI_CR1_BR_0|SPI_CR1_BR_2;//SPI_CR1_BR_2|SPI_CR1_BR_1|SPI_CR1_BR_0;
	SPI2 -> CR1 |= SPI_CR1_MSTR|br; // stm is master // baud rate is 48Mhz/256 = 187Khz
...
void dma_spi_init_lcd(void) {
    // Your code goes here.
	spi_init_lcd(); // initialize the lcd
